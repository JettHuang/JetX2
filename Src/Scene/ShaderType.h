...
public:
	...
	virtual void SetUp(const FViewContext &InView, const FMesh &InMesh);
};
...
public:
	...
	virtual void SetUp(const FViewContext &InView, const FSkinMesh &InMesh);
};
...
public:
	...
	virtual void SetUp(const FViewContext &InView, const FLinesPatch &InLines);
};
